...
Hooks.on("updateActor", async function (actor, changed) {
  ...
  const shouldSync =
    ...
    || foundry.utils.hasProperty(changed, "system.heritage.hiddenClan.realClan")
    || foundry.utils.hasProperty(changed, "system.heritage.hiddenClan.awareness")
    || foundry.utils.hasProperty(changed, "system.heritage.hiddenClan.unlocked")
    || foundry.utils.hasProperty(changed, "system.heritage.gmOptions.hasMangekyoSharingan")
    || foundry.utils.hasProperty(changed, "system.heritage.gmOptions.hasEternalMangekyoSharingan")
    || foundry.utils.hasProperty(changed, "system.heritage.gmOptions.hasRinnegan")
    || foundry.utils.hasProperty(changed, "system.heritage.gmOptions.hasTenseigan")
    || foundry.utils.hasProperty(changed, "system.heritage.uchiha.mangekyo.rightEyePower")
    || foundry.utils.hasProperty(changed, "system.heritage.uchiha.mangekyo.leftEyePower")
